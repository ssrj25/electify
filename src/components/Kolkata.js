                ...
                <div className="card-deck card-deck-voting">
                    <div className="card card-voting">
                        ...
                        <div className="card-body">
                            ...
                            <button type="button" className="btn btn-voting btn-success" onClick={() => handleVote(1)}>
                                Give Vote
                            </button>
                        </div>
                    </div>
                    <div className="card card-voting">
                        ...
                        <div className="card-body">
                            ...
                            <button type="button" className="btn btn-voting btn-success" onClick={() => handleVote(2)}>
                                Give Vote
                            </button>
                        </div>
                    </div>
                    <div className="card card-voting">
                        ...
                        <div className="card-body">
                            ...
                            <button type="button" className="btn btn-voting btn-success" onClick={() => handleVote(3)}>
                                Give Vote
                            </button>
